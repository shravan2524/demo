...
static jsi::Value __hostFunction_NativePlatformConstantsMacOSCxxSpecJSI_getConstants(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  return static_cast<NativePlatformConstantsMacOSCxxSpecJSI *>(&turboModule)->getConstants(rt);
}

NativePlatformConstantsMacOSCxxSpecJSI::NativePlatformConstantsMacOSCxxSpecJSI(std::shared_ptr<CallInvoker> jsInvoker)
  : TurboModule("PlatformConstants", jsInvoker) {
  methodMap_["getConstants"] = MethodMetadata {0, __hostFunction_NativePlatformConstantsMacOSCxxSpecJSI_getConstants};
}
...
static jsi::Value __hostFunction_NativeAccessibilityManagerCxxSpecJSI_getCurrentHighContrastState(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  static_cast<NativeAccessibilityManagerCxxSpecJSI *>(&turboModule)->getCurrentHighContrastState(rt, args[0].asObject(rt).asFunction(rt), args[1].asObject(rt).asFunction(rt));
  return jsi::Value::undefined();
}
...
NativeAccessibilityManagerCxxSpecJSI::NativeAccessibilityManagerCxxSpecJSI(std::shared_ptr<CallInvoker> jsInvoker)
  ...
  methodMap_["getCurrentHighContrastState"] = MethodMetadata {2, __hostFunction_NativeAccessibilityManagerCxxSpecJSI_getCurrentHighContrastState};
...
NativeAddressSanitizerCrashCxxSpecJSI::NativeAddressSanitizerCrashCxxSpecJSI(std::shared_ptr<CallInvoker> jsInvoker)
