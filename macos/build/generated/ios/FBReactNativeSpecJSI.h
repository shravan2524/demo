...
struct AlertManagerBaseArgsBridging {
  static AlertManagerBaseArgs<P0, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12> fromJs(
    ...
    AlertManagerBaseArgs<P0, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12> result{
      ...
      bridging::fromJs<P10>(rt, value.getProperty(rt, "defaultInputs"), jsInvoker),
      bridging::fromJs<P11>(rt, value.getProperty(rt, "modal"), jsInvoker),
      bridging::fromJs<P12>(rt, value.getProperty(rt, "critical"), jsInvoker)};
    return result;
  }

  static jsi::Object toJs(
      jsi::Runtime &rt,
      const AlertManagerBaseArgs<P0, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12> &value) {
    auto result = facebook::jsi::Object(rt);
    if (value.title) {
    ...
    if (value.defaultInputs) {
      result.setProperty(rt, "defaultInputs", bridging::toJs(rt, value.defaultInputs.value()));
    }
    if (value.modal) {
      result.setProperty(rt, "modal", bridging::toJs(rt, value.modal.value()));
    }
    if (value.critical) {
      result.setProperty(rt, "critical", bridging::toJs(rt, value.critical.value()));
    }
    return result;
  }
};
...
class JSI_EXPORT NativePlatformConstantsMacOSCxxSpecJSI : public TurboModule {
protected:
  NativePlatformConstantsMacOSCxxSpecJSI(std::shared_ptr<CallInvoker> jsInvoker);
...
template <typename T>
class JSI_EXPORT NativePlatformConstantsMacOSCxxSpec : public TurboModule {
public:
  jsi::Value get(jsi::Runtime &rt, const jsi::PropNameID &propName) override {
    return delegate_.get(rt, propName);
  }
...
protected:
  NativePlatformConstantsMacOSCxxSpec(std::shared_ptr<CallInvoker> jsInvoker)
    : TurboModule("PlatformConstants", jsInvoker),
      delegate_(static_cast<T*>(this), jsInvoker) {}

private:
  class Delegate : public NativePlatformConstantsMacOSCxxSpecJSI {
  public:
    Delegate(T *instance, std::shared_ptr<CallInvoker> jsInvoker) :
      NativePlatformConstantsMacOSCxxSpecJSI(std::move(jsInvoker)), instance_(instance) {}
...
public:
  ...
  virtual void getCurrentHighContrastState(jsi::Runtime &rt, jsi::Function onSuccess, jsi::Function onError) = 0;
...
private:
  ...
  public:
    ...
    void getCurrentHighContrastState(jsi::Runtime &rt, jsi::Function onSuccess, jsi::Function onError) override {
      static_assert(
          bridging::getParameterCount(&T::getCurrentHighContrastState) == 3,
          "Expected getCurrentHighContrastState(...) to have 3 parameters");

      return bridging::callFromJs<void>(
          rt, &T::getCurrentHighContrastState, jsInvoker_, instance_, std::move(onSuccess), std::move(onError));
    }
...
class JSI_EXPORT NativeAddressSanitizerCrashCxxSpecJSI : public TurboModule {
protected:
  NativeAddressSanitizerCrashCxxSpecJSI(std::shared_ptr<CallInvoker> jsInvoker);
...
template <typename T>
class JSI_EXPORT NativeAddressSanitizerCrashCxxSpec : public TurboModule {
public:
  jsi::Value get(jsi::Runtime &rt, const jsi::PropNameID &propName) override {
    return delegate_.get(rt, propName);
  }
...
protected:
  NativeAddressSanitizerCrashCxxSpec(std::shared_ptr<CallInvoker> jsInvoker)
    : TurboModule("RCTAddressSanitizerCrash", jsInvoker),
      delegate_(static_cast<T*>(this), jsInvoker) {}

private:
  class Delegate : public NativeAddressSanitizerCrashCxxSpecJSI {
  public:
    Delegate(T *instance, std::shared_ptr<CallInvoker> jsInvoker) :
      NativeAddressSanitizerCrashCxxSpecJSI(std::move(jsInvoker)), instance_(instance) {}
